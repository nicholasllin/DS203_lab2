...
meat_count_coef <- model2$coefficients[1]
meat_count2_coef <- model2$coefficients[1]
x_points = c(0,.5,1,1.5,2,2.5,3,3.5,4,4.5,5)
y_points = intercept + x_points*meat_count_coef + (x_points^2)*meat_count2_coef
```
# Introduction (1)
