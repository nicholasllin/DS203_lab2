...
```{r model1: any meat}
model1 <- lm(total_sales ~ is_vegetarian + ingredeint_count + month_02 + month_03 + month_04 + month_05 + month_06 + month_07 + month_08 + month_09 + month_10 + month_11 + month_12, data = test)
summary(model1)
```
...
model2 <- lm(total_sales ~ meat_count + ingredeint_count + alt_sauce + alt_cheese + month_02 + month_03 + month_04 + month_05 + month_06 + month_07 + month_08 + month_09 + month_10 + month_11 + month_12, data = test)
summary(model2)
```
...
stargazer(models_list, title = "Linear Regression Model for General Votes",
          align = TRUE,       
          dep.var.caption = "Dependent Variable:",  
          dep.var.labels.include = TRUE,           
          covariate.labels = c("Vegetarian", "Meat Count", "Ingredient Count", "Alternate Sauce", "Alternate Cheese", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "Intercept"),  
...
covariate_labels <- c("Vegetarian", "Meat Count", "Ingredient Count", "Alternate Sauce", "Alternate Cheese", "Intercept")

omit <- c("month_02", "month_03", "month_04", "month_05", "month_06", "month_07", "month_08", "month_09", "month_10", "month_11", "month_12")


stargazer(models_list, title = "Table 1: Estimated Regressions",
          align = TRUE,       
          dep.var.caption = "Dependent Variable:",  
          dep.var.labels.include = TRUE,           
          ...
          dep.var.labels = "Total Sales ($)",  
          omit = omit,
          #add.lines = list(c("Month Control", "$\\checkmark$", "$\\checkmark$")),
          add.lines = list(c("Month Control", "$\\checkmark$", "$\\checkmark$"), c("\\hline", "", "")),
          omit.stat = c("f"),
          #out = "regression_table.tex"  # Output the LaTeX code to a .tex file
          #type = "text"
          type = "latex"
